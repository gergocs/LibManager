...
class Users
{
  public:
    ...
    const int32_t &getValueOfPermissions() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getPermissions() const noexcept;
    ///Set the value of the column permissions
    void setPermissions(const int32_t &pPermissions) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> permissions_;
    struct MetaData
    {
