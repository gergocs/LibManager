...
class Record
{
  public:
     ...
     */
    explicit Record(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Record(const Json::Value &pJson) noexcept(false);
     ...
     */
    Record(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Record>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Record>;
#endif
